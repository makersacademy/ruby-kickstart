...
def add_more_ruby(string)                             #definces the method and accepts 1 parameter
  string.gsub('sad','happy').gsub('Sad','Happy')      #takes the string and substitutes the word sad for happy with and without capital letters.
end                                                   #ends the method