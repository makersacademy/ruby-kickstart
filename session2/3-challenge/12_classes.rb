...
class Fraction
  ...
  def lowest
    lowestDenominator =  gcd(@numerator, @denominator)
    lowNumerator =  @numerator / lowestDenominator
    lowDenominator = @denominator / lowestDenominator
    Fraction.new(lowNumerator, lowDenominator)
  end
