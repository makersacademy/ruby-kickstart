...
class Fraction
	...
	def gcd(a,b)
  	...
  	def lowest 
		return Fraction.new(@numerator / gcd(@numerator, @denominator), @denominator / gcd(@numerator, @denominator))
	end	
...
# myFraction = Fraction.new(20,60)

# myFraction.denominator #60

# myFraction.lowest

# puts myFraction.denominator #3
