...
class User
	...
	def add_blog(date, text)
		...
		blogs << new_blog
		self.blogs = blogs.sort_by {|i| i.date }.reverse
		new_blog
	end

	# it should have a method blogs 
	# which returns an array of all blogs the user has written
...
class Blog
	...
	# have a method called summary 
	# that returns the first 10 words from the text (or the entire text if it is less than 10 words)
	def summary
		text.split[0..9].join(' ')
	end
...
#puts lissa.blogs                     # => [#<Blog:0x007fec28c49b88
...
#puts  lissa.blogs                     # => [ blog1 , blog4 , blog2 , blog3 ] this is
# not how it will actually appear. Please see lines 28-32 for how unnamed blog objects will
# appear.
#
# blog5 = Blog.new Date.today, lissa, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce orci nunc, porta non tristique eu, auctor tincidunt mauris.  Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam vitae nibh sapien. Curabitur  eget eros bibendum justo congue auctor non at turpis. Aenean feugiat vestibulum mi ac pulvinar. Fusce ut felis justo, in porta lectus."
# BLOG_ENTRY
#
#puts blog5.summary   # => "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce orci"
