...
class User
   ...
   def add_blog(date, text)
     # Add new blog and push to array of blogs
   ...
   def blogs
     # Returns array of all blogs the user has written sorted by date
 ...
 class Blog
  ...
  def entry
     user.username.to_s + " " + date.to_s + "\n" + text
   end
   
   def summary
     # Returns first 10 words of the text
