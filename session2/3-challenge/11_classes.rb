...
class BeerSong
	...
	attr_accessor :beers # what is the difference betwee :beers and 'beers'?
	...
	def verse(n)
		if n.zero?
			...
			puts "#{num_string n} #{bottle n} of beer on the wall," 		,
					"#{num_string n} #{bottle n} of beer,"					,
					"Take one down, pass it around," 						,
					"#{num_string n - 1} #{bottle n-1} of beer on the wall."
		end
	end
    ...
    if 0 <= n && n <= 19
      ...
      "#{num_string n/10*10}-#{num_string n%10}".downcase
    end.capitalize
  end
end	
