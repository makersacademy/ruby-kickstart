...
#   attr_accessor :get_bottles

#   def initialize(get_bottles)
#     get_bottles = 0
#     @get_bottles = get_bottles
#   end

#   def song_lyrics_1
#     while @get_bottles >= 2
#     puts "@get_bottles of beer on the wall,\n @get_bottles of beer,\n Take one down, pass it around,\n @minus_bottle bottles of beer on the wall."
#     end
#   end

#   def song_lyrics_2
#     if @get_bottles == 1
#       puts "One bottle of beer on the wall,\n One bottle of beer,\n Take one down, pass it around,\m Zero bottles of beer on the wall"
#     end
#   end
