...
#     while @beers > 0
#       tens_place = @beers / 10
#       current << tens[tens_place-1] if tens_place > 1
#       current << ones[@beers-(tens_place*10)]
#       string << "#{current} bottles of beer on the wall. #{current} bottles of beer on the wall. #{current} bottles of beer. Take one down, pass it around, "
#       current = ''
#       @beers-=1
#     end
#     puts string
