...
#		elsif number == 1
#
#			puts number.to_words + ' bottle of beer on the wall, ' + number.to_words + ' bottle of beer,' 
#			puts 'Take one down, pass it around, ' + (number -1).to_words + ' bottles of beer on the wall.'
#
#		else number > 2 && number < 99
#
#			puts number.to_words + ' bottles of beer on the wall, ' + number.to_words + ' bottles of beer,'
#			puts 'Take one down, pass it around, ' + (number -1).to_words + ' bottles of beer on the wall.'
#		
#		end
#
...
#puts  BeerSong.new(0).print_song 
