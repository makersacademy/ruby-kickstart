...
array2 = ["zero", "ten", "twenty", "thrity", "fourty", "fifty", "sixty", "seventy", "eighty", "ninety"]
array3 = ["eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"]
=end
