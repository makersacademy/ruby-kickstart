...
puts head = {:data => 1, :next => nil}
puts middle head                        # => 1
puts head = {:data => 2, :next => head}
puts middle head                        # => 1
puts head = {:data => 3, :next => head}
puts middle head                        # => 2
puts head = {:data => 4, :next => head}
puts middle head                        # => 2
puts head = {:data => 5, :next => head}
puts middle head                        # => 3
puts head = {:data => 6, :next => head}
puts middle head                        # => 3
